             ...
             <div className='flex items-center w-full gap-x-10'>
               ...
               <div className='flex items-center w-full gap-x-10'>
                ...
                <label className='w-full'>
                  ...
                  <input {...register('images')} accept='image/*' onChange={(e)=>setImage(e.target.files[0])}  className='w-full bg-[#F7F7F7] px-4 py-1.5 md:py-2.5 border-2 border-gray-400 rounded-md focus:ring-2 focus:ring-blue-400 mb-7' type="file" placeholder='avatar' />
                </label>
             </div>
